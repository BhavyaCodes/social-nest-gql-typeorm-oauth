/* 82f3dc804be09c1c11f43deb10048837b1a93c72
...
export declare type FindCommentsByPostQueryVariables = Types.Exact<{
  findCommentsByPostPostId: Types.Scalars['ID'];
}>;
export declare type FindCommentsByPostQuery = {
  __typename?: 'Query';
  findCommentsByPost: Array<{
    __typename?: 'Comment';
    id: string;
    content: string;
    user: {
...
export declare const FindCommentsByPostDocument: Apollo.DocumentNode;
/**
 * __useFindCommentsByPostQuery__
 *
 * To run a query within a React component, call `useFindCommentsByPostQuery` and pass it any options that fit your needs.
 * When your component renders, `useFindCommentsByPostQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 *   variables: {
 *      findCommentsByPostPostId: // value for 'findCommentsByPostPostId'
 *   },
 * });
 */

export declare function useFindCommentsByPostQuery(baseOptions: Apollo.QueryHookOptions<FindCommentsByPostQuery, FindCommentsByPostQueryVariables>): Apollo.QueryResult<FindCommentsByPostQuery, Types.Exact<{
  findCommentsByPostPostId: string;
}>>;
export declare function useFindCommentsByPostLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FindCommentsByPostQuery, FindCommentsByPostQueryVariables>): Apollo.QueryTuple<FindCommentsByPostQuery, Types.Exact<{
  findCommentsByPostPostId: string;
}>>;
export declare type FindCommentsByPostQueryHookResult = ReturnType<typeof useFindCommentsByPostQuery>;
export declare type FindCommentsByPostLazyQueryHookResult = ReturnType<typeof useFindCommentsByPostLazyQuery>;
export declare type FindCommentsByPostQueryResult = Apollo.QueryResult<FindCommentsByPostQuery, FindCommentsByPostQueryVariables>;