/* 236061898f7072dd8ff3ae929f57c94ccb5ea20a
...
export declare type GetUsersWhoLikedPostQueryVariables = Types.Exact<{
  getUsersWhoLikedPostId: Types.Scalars['ID'];
}>;
export declare type GetUsersWhoLikedPostQuery = {
  __typename?: 'Query';
  getUsersWhoLikedPost: Array<{
    __typename?: 'User';
    id: string;
    name: string;
    imageUrl?: Types.Maybe<string>;
...
export declare const GetUsersWhoLikedPostDocument: Apollo.DocumentNode;
/**
 * __useGetUsersWhoLikedPostQuery__
 *
 * To run a query within a React component, call `useGetUsersWhoLikedPostQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUsersWhoLikedPostQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUsersWhoLikedPostQuery({
 *   variables: {
 *      getUsersWhoLikedPostId: // value for 'getUsersWhoLikedPostId'
 *   },
 * });
 */

export declare function useGetUsersWhoLikedPostQuery(baseOptions: Apollo.QueryHookOptions<GetUsersWhoLikedPostQuery, GetUsersWhoLikedPostQueryVariables>): Apollo.QueryResult<GetUsersWhoLikedPostQuery, Types.Exact<{
  getUsersWhoLikedPostId: string;
}>>;
export declare function useGetUsersWhoLikedPostLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUsersWhoLikedPostQuery, GetUsersWhoLikedPostQueryVariables>): Apollo.QueryTuple<GetUsersWhoLikedPostQuery, Types.Exact<{
  getUsersWhoLikedPostId: string;
}>>;
export declare type GetUsersWhoLikedPostQueryHookResult = ReturnType<typeof useGetUsersWhoLikedPostQuery>;
export declare type GetUsersWhoLikedPostLazyQueryHookResult = ReturnType<typeof useGetUsersWhoLikedPostLazyQuery>;
export declare type GetUsersWhoLikedPostQueryResult = Apollo.QueryResult<GetUsersWhoLikedPostQuery, GetUsersWhoLikedPostQueryVariables>;